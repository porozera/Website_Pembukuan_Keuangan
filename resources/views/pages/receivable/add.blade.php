...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Add Receivables'])
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0"><b>Add Receivables</b></p>
                        </div>
                    </div>
                    <div class="card-body">
                        <form role="form" method="POST" action="{{ route('receivable.add.perform') }}" enctype="multipart/form-data" id="receivableAddForm">
                            @csrf
                            @method('POST')
                            <div class="row">
                                <div class="col-md-6">
    ...
    <script>
        document.getElementById('submitFormButton').addEventListener('click', function () {
            // Submit the form
            document.getElementById('receivableAddForm').submit();
        });
    </script>
@endsection
