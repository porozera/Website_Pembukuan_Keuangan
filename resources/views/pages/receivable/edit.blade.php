...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Edit Receivable'])
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0"><b>Edit Receivable</b></p>
                            </div>
                        </div>
                        <div class="card-body">
                            <form role="form" method="POST" action="/receivable/edit/{{$receivable['id']}}/perform" enctype="multipart/form-data" id="receivableEditForm">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="amount" value="{{$receivable['amount']}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="interest_rate" value="{{$receivable['interest_rate']}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="due_date" value="{{$receivable['due_date']}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status">
                                                <option selected value="{{$receivable['status']}}">{{$receivable['status']}}</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" type="text" name="description">{{$receivable['description']}}</textarea>
        ...
        <script>
            document.getElementById('submitFormButton').addEventListener('click', function () {
                // Submit the form
                document.getElementById('receivableEditForm').submit();
            });
        </script>
@endsection
