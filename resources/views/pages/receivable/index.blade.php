...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Receivables'])
                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col d-flex justify-content-between align-items-center">
                                <h6><b>Receivables Table</b></h6>
                                <button class="btn btn-primary btn-sm">
                                    <a href="/receivable/add" class="text-white">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    @php
                                        $number = ($receivable->currentPage() - 1) * $receivable->perPage() + 1; 
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm px-3">
                                            <a href="/receivable/edit/{{$item['id']}}" class="text-primary font-weight-bold text-xs me-3"
                                               data-toggle="tooltip" data-original-title="Edit receivable">
                                                <b>Edit</b>
                                            </a>
                                            <form action="/receivable/delete/{{ $item['id'] }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class="card-footer">
                                {{ $receivable->links('vendor.pagination.bootstrap-5') }}
                            </div>                            
                    </div>
                </div>
            </div>
