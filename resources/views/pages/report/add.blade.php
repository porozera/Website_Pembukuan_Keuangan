                            ...
                            <form role="form" method="POST" action="{{ route('debt.add.perform') }}" enctype="multipart/form-data" id="debtAddForm">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="report_date" class="form-control-label">Due Date</label>
                                            <input class="form-control" type="date" name="report_date">
                                            @error('report_date') <p class="text-danger text-xs pt-1"> {{$message}} </p>@enderror
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-2">
