...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Tambah HPP'])
        <div class="container">              
            <div class="row mb-5">
                <div class="col">
                            ...
                            <form role="form" method="POST" action="{{ route('hpp.add.perform') }}" enctype="multipart/form-data" id="hppAddForm">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="raw_material_cost" id="raw_material_cost" class="form-control" placeholder="Rp">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="labor_cost" id="labor_cost" class="form-control" placeholder="Rp">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="overhead_cost" id="overhead_cost" class="form-control" placeholder="Rp">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="packaging_cost" id="packaging_cost" class="form-control" placeholder="Rp">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="other_production_costs" id="other_production_costs" class="form-control" placeholder="Rp">
