...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Edit Akun'])
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0"><b>Edit Akun</b></p>
                            </div>
                        </div>
                        <div class="card-body">
                            <form role="form" method="POST" action="/account/edit/{{$account['id']}}/perform" enctype="multipart/form-data" id="accountAddForm">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="name" placeholder="Ex : Kas" value="{{$account['name']}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="code" placeholder="Ex : 1-10001" value="{{$account['code']}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="category">
                                                    <option selected>{{$account['category']}}</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" type="text" name="description" placeholder="">{{$account['description']}}</textarea>
